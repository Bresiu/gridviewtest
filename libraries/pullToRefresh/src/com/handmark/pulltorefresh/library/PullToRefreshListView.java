...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public void updateItemAtPosition(int position) {
        int visiblePosition = mRefreshableView.getFirstVisiblePosition();
        View tempSelectedView = mRefreshableView.getChildAt(position - visiblePosition);
        mRefreshableView.getAdapter().getView(position, tempSelectedView, mRefreshableView);
    }
