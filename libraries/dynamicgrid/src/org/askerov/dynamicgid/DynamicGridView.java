...
public class DynamicGridView extends GridView {
    ...
    private BitmapDrawable getAndAddHoverView(View v) {
        ...
        mHoverCellOriginalBounds = new Rect(left - 20, top - 20, left + w + 20, top + h + 20);
        mHoverCellCurrentBounds = new Rect(mHoverCellOriginalBounds);

        bitmapDrawable.setBounds(mHoverCellCurrentBounds);
        // Add alpha to bitmap
        bitmapDrawable.setColorFilter(0xBB000000, PorterDuff.Mode.DST_IN);
        // Add antyaliasing to bitmap
